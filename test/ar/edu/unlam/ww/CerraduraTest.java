...
public class CerraduraTest {
	...
	public void testAbrirTrue() {
		...
		Cerradura miCerradura = new Cerradura(claveATestear,
				cantidadDeAperturasPosibles);
	...
	public void testGetAperturasExitosas() {
		...
		Assert.assertEquals(cantidadDeAperturas,
				miCerradura.cantidadDeAperturasExitosas());
	}

	@Test
	public void testGetAperturasFallidas() {
		Integer claveATestear = 1234;
		...
		Assert.assertEquals(cantidadDeAperturas,
				miCerradura.cantidadDeAperturasFallidas());
	}
	...
	public void testEstaBloqueada(){
		...
		miCerradura.abrir(claveFalsa);
		miCerradura.abrir(claveFalsa);
		Assert.assertTrue(miCerradura.bloqueada());
	}
}
